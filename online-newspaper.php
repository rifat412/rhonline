...
<body class="main-layout">
    ...
    <div id="mySidepanel" class="sidepanel">
        ...
        <a href="about.html">ONLINE TV</a>
        <a href="searvices.html">ONLINE NEWSPAPER</a>
        <a href="testimonial.html">FIND HOSPITAL</a>
        <a href="works.html">FIND BLOOD</a>
    ...
    <div class="wallet">
        <div class="container-fluid">
            <div class="container-fluid text-center py-5" >
                ...
                <h5 class="h1">ONLINE NEWSPAPER</h5>
