                ...
                <div class="row d_flex">
                    ...
                    <div class="col-sm-4">
                        <ul class="email text_align_right">
                            <li class="d_none"><a href="create_account.html" target="_blank"><i class="fa fa-user" aria-hidden="true"></i></a></li>
                            <li class="d_none"> <a href="https://www.google.com/" target="_blank"><i class="fa fa-search" style="cursor: pointer;" aria-hidden="true"></i></a> </li>
                            <li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="testomoniam_text text_align_center">
                                                                <i><img src="images/sir.jpeg" alt="loading"/></i>
                                                                <h3>Ahmed Shafkat</h3>
                                                                <span>Lecturer, CSE <br>Sonargaon University</span>
                                                                <!--<span>Sonargaon University (SU), Dhaka  </span>-->
                                            ...
                                            <div class="container">
                                                <div class="carousel-caption posi_in">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="testomoniam_text text_align_center">
                                                                <i><img src="images/Rifat.jpg" alt="loading"/></i>
                                                                <h3>Rifat</h3>
                                                                <span>Lecturer, CSE <br>Sonargaon University</span>
                                                                <img src="images/icon.png" alt="#" />
                                                            </div>
